...
@interface HomeClassifyViewController () <UICollectionViewDataSource, UICollectionViewDelegate,MRWaterflowLayoutDelegate>
/** 所有的商品数据 */
...
@implementation HomeClassifyViewController
...
- (void)loadNewShops
{
    ...
    NSString * url = [NSString stringWithFormat:@"https://api.zhetaoke.com:10001/api/api_all.ashx?appkey=f6cfb493dd7843b49b4f9bb5d839c061&sid=160008&page=%ld&page_size=30&cid=%@",self.page,self.cid];
...
- (void)loadMoreShops
{
    self.page += 1;
    //一级商品分类，值为空：全部商品，1：女装，2：母婴，3：美妆，4：居家日用，5：鞋品，6：美食，7：文娱车品，8：数码家电，9：男装，10：内衣，11：箱包，12：配饰，13：户外运动，14：家装家纺
    NSString * url = [NSString stringWithFormat:@"https://api.zhetaoke.com:10001/api/api_all.ashx?appkey=f6cfb493dd7843b49b4f9bb5d839c061&sid=160008&page=%ld&page_size=30&cid=%@",self.page,@"1"];
    [XXZHttpUtil getWithURLString:url parameters:@{} success:^(id res) {
